...
class ExcelPipeline implements Pipeline {
    ...
    void process(ResultItems resultItems, Task task) {
        ...
        newRow.getCell(1).setCellValue((resultItems.get('buliN') as String).replaceAll('网', ''))
        newRow.getCell(2).setCellValue((resultItems.get('buliN') as String).replaceAll('网', ''))
        newRow.getCell(3).setCellValue(resultItems.get('oName') as String)
        newRow.getCell(4).setCellValue((resultItems.get('distr') as String).replaceAll('楼盘', ''))
        newRow.getCell(5).setCellValue(resultItems.get('street') as String)
        ...
        newRow.getCell(26).setCellValue(resultItems.get('curR') as String)
        ...
        newRow.getCell(33).setCellValue(resultItems.get('water') as String)
        newRow.getCell(34).setCellValue(resultItems.get('warm') as String)
        newRow.getCell(35).setCellValue(resultItems.get('elec') as String)
        newRow.getCell(36).setCellValue(resultItems.get('gas') as String)
        newRow.getCell(37).setCellValue(resultItems.get('commu') as String)
        newRow.getCell(38).setCellValue(resultItems.get('hegi') as String)
        newRow.getCell(39).setCellValue(resultItems.get('commu') as String)
        newRow.getCell(40).setCellValue(resultItems.get('safe') as String)
        newRow.getCell(41).setCellValue(resultItems.get('layout') as String)
        newRow.getCell(42).setCellValue(resultItems.get('entry') as String)
        newRow.getCell(43).setCellValue(resultItems.get('hegi') as String)
        ...
        newRow.getCell(65).setCellValue(resultItems.get('tel') as String)

        if (origin == Pattern.ORIGIN_OLD) {
            newRow.getCell(8).setCellValue(resultItems.get('zip') as String)
            newRow.getCell(9).setCellValue(resultItems.get('compT') as String)
            newRow.getCell(32).setCellValue(resultItems.get('pDes') as String)
            try {
                ...
                newRow.getCell(28).setCellValue(df.format(curR / allR))
            } catch (Exception ignored) {
                newRow.getCell(28).setCellValue('')
            }
        } else {
