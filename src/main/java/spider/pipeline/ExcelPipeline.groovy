...
class ExcelPipeline implements Pipeline {
    ...
    void process(ResultItems resultItems, Task task) {
        ...
        newRow.getCell(38).setCellValue(resultItems.get('layout') as String)
        newRow.getCell(39).setCellValue(resultItems.get('entry') as String)
        newRow.getCell(40).setCellValue(resultItems.get('hegi') as String)
        newRow.getCell(41).setCellValue(resultItems.get('parkA') as String)
        newRow.getCell(42).setCellValue(resultItems.get('kin') as String)
        newRow.getCell(43).setCellValue(resultItems.get('school') as String)
        newRow.getCell(44).setCellValue(resultItems.get('college') as String)
        newRow.getCell(45).setCellValue(resultItems.get('mall') as String)
        newRow.getCell(46).setCellValue(resultItems.get('capital') as String)
        newRow.getCell(47).setCellValue(resultItems.get('post') as String)
        newRow.getCell(48).setCellValue(resultItems.get('bank') as String)
        newRow.getCell(49).setCellValue((resultItems.get('env') as String).replaceAll('\n', ';'))
        newRow.getCell(50).setCellValue(resultItems.get('bus') as String)
        newRow.getCell(51).setCellValue(resultItems.get('subWay') as String)
        newRow.getCell(53).setCellValue(resultItems.get('capt') as String)
        newRow.getCell(54).setCellValue(resultItems.get('res') as String)
        newRow.getCell(55).setCellValue(resultItems.get('mall') as String)
        newRow.getCell(56).setCellValue(resultItems.get('env') as String)
        newRow.getCell(57).setCellValue((resultItems.get('other') as String)?.replaceAll('\n', ';'))
        newRow.getCell(58).setCellValue(resultItems.get('courI') as String)
        newRow.getCell(59).setCellValue(resultItems.get('decoC') as String)
        newRow.getCell(60).setCellValue(resultItems.get('saleS') as String)
        newRow.getCell(61).setCellValue(resultItems.get('saleA') as String)
        newRow.getCell(62).setCellValue(resultItems.get('tel') as String)

        if (origin == Pattern.ORIGIN_OLD) {
            rentInfo.rentExcel.put(resultItems.get('builN') as String, newRow.getRowNum())
            ...
            newRow.getCell(6).setCellValue(SpiderService.getPostCode(resultItems.get('distr') as String))
            newRow.getCell(7).setCellValue(age)
            newRow.getCell(29).setCellValue(extraInfo)
        }

        String edu = resultItems.get('kin') + '\t' + resultItems.get('school') + '\t' + resultItems.get('college')
        newRow.getCell(52).setCellValue(edu)
    }
    ...
    public static void combine() {
        ...
        for (int i = 0; i < sheet.getLastRowNum(); i++) {
            String buildingName = RentInfo.rentExcel.get(i)
            String rentPrice = RentInfo.rentPage.get(buildingName)
            if (rentPrice != null) sheet.getRow(i).getCell(10).setCellValue(rentPrice)
        }
    }
